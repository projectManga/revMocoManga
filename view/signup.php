                    ...
                    <div class="header__nav">
                        <nav class="header__menu mobile-menu">
                            <ul>
                                ...
                                <li><a href="./listmanga.php">List Manga</a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="header__nav">
                        <nav class="header__menu mobile-menu">
                            <ul>
                                ...
                                <li class="active"><a href="./login.php"><span class="icon_profile arrow_carrot-down"></span></a>
                                    <ul class="dropdown">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="login__form">
                        <h3>Sign Up</h3>
                        <form action="../proses/signuproses.php" method="POST">
