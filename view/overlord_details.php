...
<head>
    ...
    <title>mocoManga | Overlord</title>
    ...
    <section class="anime-details spad">
        <div class="container">
            <div class="anime__details__content">
                <div class="row">
                    <div class="col-lg-3">
                        <div class="anime__details__pic set-bg" data-setbg="../img/overlord.jpg">
                    ...
                    <div class="col-lg-9">
                        <div class="anime__details__text">
                            ...
                            <p>Pada tahun 2126, Game Dive Massively Multiplayer Online Role Playing Game atau DMMORPG bernama Yggdrasil dirilis. Itu menonjol di antara semua DMMORPG lain karena kemampuannya yang luar biasa tinggi bagi pemain untuk berinteraksi dengan permainan. Setelah beroperasi selama 12 tahun, server game akan segera dimatikan. Dalam game ada guild, Ainz Ooal Gown, yang pernah terdiri dari 41 anggota dan dikreditkan sebagai salah satu guild terkuat dalam game. Sekarang hanya 4 anggota yang tersisa, 37 lainnya telah keluar dari permainan. Dari 4 itu hanya satu, karakter alder lich bernama Momonga, yang terus bermain sebagai pemimpin serikat dan mempertahankan markas mereka, The Great Tomb of Nazarick.</p>
                            <div class="anime__details__widget">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6">
                                        <ul>
                                            <li><span>Type:</span> Manga</li>
                                            <li><span>Author:</span> Kugane Maruyama & Satoshi Oshio</li>
                                            <li><span>Illustrator:</span> so-bin</li>
                                            <li><span>Publisher:</span> Kadokawa Shoten</li>
                                            <li><span>Date aired:</span> November 26, 2014 to ?</li>
                                        </ul>
                                    </div>
                                    <div class="col-lg-6 col-md-6">
                                        <ul>
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-8">
                        <div class="anime__details__review">
                            ...
                            <div class="overflow">
                                <ul>
                                    <li><a href="chapter1_overlord.php">Chapter 01</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="anime__details__review">
